...
4 - Não utilize filtros repetidos | :heavy_check_mark:
5 - Apague o filtro de valores numéricos e desfaça as filtragens dos dados da tabela ao clicar no ícone de `X` de um dos filtros | :heavy_multiplication_x:
6 - Ordene as colunas de forma ascendente ou descendente | :heavy_multiplication_x:
